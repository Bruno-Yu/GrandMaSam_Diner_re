  ...
  <main>
    <div class="grid gap-2 grid-cols-1 xl:grid-cols-2 h-screen">
      <div class="relative flex flex-col mb-8 xl:mb-0 h-screen overflow-hidden">
        ...
        <div class="relative z-10 overflow-x-auto sm:-mx-6 lg:-mx-8">
          <div class="py-4 min-w-full flex flex-col sm:px-6 lg:px-8">
            <h2 class="text-5xl font-bold pt-5 pb-8 underline decoration-4 decoration-amber-400/80">訂單管理</h2>
                      ...
                      <div class="flex justify-center">
                        <div class="form-check form-switch">
                          <input
                            ...
                            :checked="item.is_paid === 1 ? true : false">
      ...
      <div class=" flex justify-end my-3  mr-4">
        ...
        <p class="relative z-10 font-semibold pl-2">目前頁面訂單共 {{ Object.keys(adminShown)?.length }} 筆</p>
      </div>
      <div class="h-screen p-2" :class="{ 'bg-black': Object.keys(currentItem).length, 'bg-white': !Object.keys(currentItem).length }">
        ...
        <div v-else  class="flex flex-col justify-center items-center h-5/6" >
          ...
          <p class="text-4xl font-bold">點選查詢按鈕可查看訂單細節</p>
        </div>
      </div>
    </div>
...
const { pagination, editModal, infoModal, hideInfoModal, isNew, openDeleteModal, openModal, hideModal, openNewModal, editAdminShown, addAdminShown, getAdminShown, deleteAdminShown, getAdminSingleShown } = useApiModal();
