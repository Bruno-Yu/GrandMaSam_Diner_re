<template>
  <main>
    <div class="grid gap-2 grid-cols-1 xl:grid-cols-2 h-screen">
      <div class="relative flex flex-col mb-8 xl:mb-0 overflow-hidden">
                      ...
                      <div class="flex justify-center">
                        <div class="form-check form-switch">
                          <input
                            ...
                            type="checkbox" role="switch" id="isPublishedBtn"
                            :checked="item.isPublic ? true : false">
                          <label class="form-check-label block text-gray-800"
                            for="isPublishedBtn"></label>
                        </div>
                      </div>
                    </td>
                    <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
            ...
            <div class="flex flex-col  rounded mb-5 bg-gray-900 text-white border-8 border-amber-400">
              <div class="p-6 flex flex-col justify-start">
                ...
                <p class=" text-lg font-bold mb-2">
                  <span class="font-bold">作者:</span> {{ currentItem.author }}
                </p>
                <p class=" text-base mb-4">
                  <span class="font-bold">建立時間:</span> {{ currentItem.create_at }}
                </p>
                <div class="h-auto overflow-y-auto">
                  <p><span class="font-bold">文章簡述:</span> {{ currentItem.description }}</p>
