<template>
  <section class="pt-20   bg-amber-50">
    <div class="w-full flex justify-end pr-8 py-12 ">

      <div class="relative w-full  border-2 border-black  flex justify-center items-center flex-wrap h-full text-gray-800">
        ...
        <div class="w-1/5 relative   h-[600px]">
          <div class="absolute border-[2px] border-black  right-10 w-[500px] h-[600px]  z-20 px-8 py-6 bg-white ">
            <h2 class="text-5xl text-center font-bold  mb-5">登入</h2>
            <!-- form -->
            <v-form class="border p-3" ref="userInputForm"  v-slot="{ errors }" >
              <!-- Email input -->
              <div class="mb-6">
              ...
              <div class="flex justify-between items-center mb-6">
                <div class="form-group form-check">
                  ...
                  <label class="form-check-label inline-block text-gray-800 text-sm" for="rememberMe">記住我</label>
                </div>
                <a href="#!"
                  class="text-black text-base hover:text-amber-400 focus:text-amber-400 active:text-amber-400 duration-200 transition ease-in-out">
                  忘記密碼</a>
              </div>
  
              <!-- Submit button -->
              <button type="button"
                class="block px-7 py-3 bg-amber-400 text-black font-bold text-base leading-snug uppercase rounded shadow-md hover:bg-amber-500  focus:bg-amber-500 active:bg-amber-500 transition duration-150 ease-in-out w-full"
            ...
            <div class="flex justify-center">
              <button type="button" class="text-center text-sm text-stone-800 mt-3">註冊</button>
            </div>
          </div>
          <div class="flex justify-end">
              <p class="text-5xl text-vertical uppercase font-bold">login  登入</p>
          </div>
        </div>
      </div>
    </div>
