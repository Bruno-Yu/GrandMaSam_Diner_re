    ...
    <div class="bg-black py-1">
      <div class=" py-4 text-center bg-[url('/assets/images/product_intro_2.webp')]  bg-fixed bg-blend-darken">
        <h3 class="text-3xl italic text-white font-bold leading-relaxed">
          成功其實是1分的實力加上99分的心意<br>不要讓吝嗇限制了您人生的高度<br><span class="text-base font-bold not-italic text-black "> 出自- 1995 五歲就會抬頭的創辦人</span>
        </h3>
      </div>
    </div>
    <div class="bg-[url('/assets/images/Thanks_boss.webp')] h-[500px] w-full bg-cover flex flex-col items-center">
