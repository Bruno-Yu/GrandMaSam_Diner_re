...
<!-- Toggler -->
  <main class="relative grid grid-cols-8">
      <!-- Sidenav -->
<nav
  class="col-span-1 z-[1035] h-full w-full overflow-hidden bg-white shadow-[0_4px_12px_0_rgba(0,0,0,0.07),_0_2px_4px_rgba(0,0,0,0.05)] dark:bg-zinc-800"
>
  <NuxtLink class=" 
          block
          group
    ...
    <p class="text-3xl font-serif group-hover:text-amber-400">GRANDMA SAM DINER</p>
    <p class="text-base  font-serif group-hover:text-amber-400"> LET MAKE AMERICA GREAT AGAIN</p>
  </NuxtLink>
  <ul
